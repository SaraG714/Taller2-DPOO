...
public class SandboxMapas
{
    ...
    public List<String> getValoresComoLista( )
    {
    	...
    	List<String> lista = new LinkedList<>(values);
    ...
    public List<String> getLlavesComoListaInvertida( )
    {
        ...
        lista.sort((s1, s2) -> s2.compareTo(s1));
        return lista;
    }
    ...
    public void agregarCadena( String cadena )
    {
        ...
        mapaCadenas.put(invertida.toString(), cadena);
    }
    ...
    {
        Map<String, String> mapMayus = new HashMap<>();
        for (Map.Entry<String, String> keyVal : mapaCadenas.entrySet()) {
            String mayusKey = keyVal.getKey().toUpperCase();
            mapMayus.put(mayusKey, keyVal.getValue());
        }
        mapaCadenas = mapMayus;
    }
