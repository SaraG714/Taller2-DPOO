...
public class SandboxConjuntos
{
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	arbolCadenas.removeIf(str -> str.equalsIgnoreCase(lower));
    ...
    {
    	NavigableSet<String> mayus = new TreeSet<>();
    	
    	for (String cadena: arbolCadenas) {
    		mayus.add(cadena.toUpperCase());
    	}
    	arbolCadenas = mayus;
    }
    ...
    {
        TreeSet<String> inverted = new TreeSet<>((a, b) -> b.compareTo(a));
        
        inverted.addAll(arbolCadenas);
